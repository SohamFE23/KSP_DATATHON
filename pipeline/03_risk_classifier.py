...
def load_data() -> pd.DataFrame:
    # Prefer district_features if available, fallback to risk_predictions
...
FEATURE_CANDIDATES = [
    ...
    "TOTAL_CRIMES", "CRIME_YOY_CHANGE", "CRIME_3YR_AVG",
    # Geo (optional)
    "LAT", "LON",
    # Year
    "YEAR",
...
def train_xgb(df: pd.DataFrame, features: list) -> tuple:
    le = LabelEncoder()
